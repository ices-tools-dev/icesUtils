...
[![version number](https://ices-tools-prod.r-universe.dev/badges/icesUtils)](https://ices-tools-prod.r-universe.dev/icesUtils)
![branch version number](https://img.shields.io/badge/branch_version-`r packageDescription("icesUtils")$Version`-blue)
[![GitHub release](https://img.shields.io/github/release/ices-tools-prod/icesUtils.svg?maxAge=6000)]()
...
icesUtils is implemented as an [R](https://www.r-project.org) package and
...
Feel free to open an [issue](https://github.com/ices-tools-dev/icesUtils/issues)
